...
import br.ufpa.facomp.diplomas.domain.Usuario;
import br.ufpa.facomp.diplomas.repository.UsuarioRepository;
...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity(EntityManager em) {
        Usuario usuario = new Usuario().login(DEFAULT_LOGIN).password(DEFAULT_PASSWORD);
        return usuario;
    }
    ...
    public static Usuario createUpdatedEntity(EntityManager em) {
        Usuario usuario = new Usuario().login(UPDATED_LOGIN).password(UPDATED_PASSWORD);
        return usuario;
    }
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.login(UPDATED_LOGIN).password(UPDATED_PASSWORD);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.login(UPDATED_LOGIN).password(UPDATED_PASSWORD);
