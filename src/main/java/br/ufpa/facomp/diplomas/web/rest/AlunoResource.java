...
/**
 * REST controller for managing {@link br.ufpa.facomp.diplomas.domain.Aluno}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AlunoResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/alunos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Aluno> partialUpdateAluno(
        ...
        Optional<Aluno> result = alunoRepository
            ...
            .map(existingAluno -> {
                ...
                if (aluno.getStatusSIGAA() != null) {
                    existingAluno.setStatusSIGAA(aluno.getStatusSIGAA());
                }
