...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aluno.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALUNO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALUNO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALUNO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALUNO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALUNO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALUNO actions', async () => {
      const expectedActions = [
        {
