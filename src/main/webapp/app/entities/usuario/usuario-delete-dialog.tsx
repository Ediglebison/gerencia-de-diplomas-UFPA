...
export const UsuarioDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gerenciamentodeDiplomasApp.usuario.delete.question">
        <Translate contentKey="gerenciamentodeDiplomasApp.usuario.delete.question" interpolate={{ id: usuarioEntity.id }}>
