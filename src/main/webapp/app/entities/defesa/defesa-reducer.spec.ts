...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './defesa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEFESA_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEFESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEFESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEFESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEFESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEFESA actions', async () => {
      const expectedActions = [
        {
