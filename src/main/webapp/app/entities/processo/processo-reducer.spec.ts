...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './processo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESSO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROCESSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROCESSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROCESSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROCESSO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROCESSO actions', async () => {
      const expectedActions = [
        {
